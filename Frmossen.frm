VERSION 5.00
Begin VB.Form frmOSSend 
   Caption         =   "DC Send Out To Vendor"
   ClientHeight    =   8460
   ClientLeft      =   870
   ClientTop       =   795
   ClientWidth     =   13095
...
Public Function inpSendOutJobSeq(iEntry As Integer) As Boolean
'==============================================================================
...
'==============================================================================
    ...
    inpSendOutJobSeq = False        'to force loop back till done
    
    Do Until inpSendOutJobSeq Or gDone
        Do Until inpSendOutJobSeq Or gDone       'Extra loop for exit do stmts
          ...
          End If
            ...
            Else
                ...
                ElseIf gJobOpers.OperStatus = "C" Then
                        ...
                        ErrorBeep
                        Exit Do
                ElseIf Left(gJobOpers.Oper, 3) <> "290" Then
                        ErrBox LoadResString(gLanguageOffset + 87), 2
                        ErrorBeep
                        Exit Do
                End If
                ...
                inpSendOutJobSeq = True     'Done - Planned
            End If
        Loop
    Loop
 lblErrMsg.Caption = ""
...
On Error GoTo ErrorHandler
  strfunctionname = "OSSendOutProcess"
...
'the user answers No to the prompt.
   Call checkClockOut
    ...
    While (I <= gLaborIn(1).NumbMachs) And bEnter
        ...
        If Not inpSendOutJobSeq(I) Then Exit Sub
   ...
   '         If Not inpWcAns(i) Then Exit Sub
    '    End If
     '   lblCCID.Caption = gLaborIn(i).CCID
        ...
        If Not inpSendOutQty(I) Then Exit Sub
...
lblFormTitle.Caption = LoadResString(gLanguageOffset + 287)
